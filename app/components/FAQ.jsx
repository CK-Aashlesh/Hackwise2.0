      ...
      >
        ...
        <div className="relative z-10 text-center space-y-6">
          ...
          >
            ...
            >
              <span className="relative z-10 font-mono text-white uppercase tracking-widest text-sm transition-colors">
                <DecryptedText text="View Questions" sequential speed={30} />
              </span>
            </div>
          </button>
        </div>
